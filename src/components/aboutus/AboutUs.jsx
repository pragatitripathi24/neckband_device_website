      ...
      >
        <div className="about-container" style={{ height: "auto" }}>
          ...
          <div className="about-content" style={{backgroundColor:"white"}}>
            ...
            <h2 className="stroke-text-main-about" style={{textAlign:"left"}}> ABOUT US</h2>
            </div>
            ...
            <div className="about-text-content" >
              <p className="about-paragraph" style={{ textAlign: "left" }}>
                ...
                veterinary professionals & researchers.<br/><br/> The wireless & GSM-based
                ...
                patterns. <br/> The data collected by the smart neckband is then
                transmitted to the animal owner's smartphone or computer,
                enabling real-time tracking and monitoring of the animal's
                health.<br/>
                <br/> The device uses advanced technologies such as AI/ML
